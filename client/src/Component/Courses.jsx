...
function Courses() {
  ...
  return (
    <section className="container mx-auto px-6 py-10">
      {/* Header */}
      <div className="flex flex-wrap items-center justify-between pb-7">
        <div>
          <h1 className="font-extrabold text-5xl pb-3">Explore Courses</h1>
          <p className="text-gray-500 text-lg font-medium">
            Advance your skills with <span className="text-orange-600 font-semibold">Dev</span>Skool
          </p>
        </div>
        ...
        <div className="relative w-full sm:w-auto mt-4 sm:mt-0">
          ...
          />
          <button className="absolute right-4 top-1/2 transform -translate-y-1/2 bg-orange-600 text-white p-2 rounded-full hover:bg-orange-700 transition">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 justify-center">
        {paginatedCourses.map((course) => (
          <Link to={`/courses/${course.id}`} key={course.id}>
            <div className="my-10 w-full max-w-xs h-100 flex flex-col justify-between rounded-xl overflow-hidden shadow-lg bg-white hover:scale-105 transition-transform duration-300 cursor-pointer">
              ...
              <div className="p-6 flex flex-col flex-grow justify-between">
                <div>
                  <div className="flex items-center mb-2">
                    ...
                    <span className="text-gray-500 ml-2">({course.numberOfStudents})</span>
                  </div>
